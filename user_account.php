...
// Get user's bookings with bus details
$bookings_query = $conn->prepare("
    SELECT b.*, bs.bus_name, bs.bus_number, bs.from_city, bs.to_city, 
...
<script>
    ...
    console.log("%c✓ Profile Settings | Change Password | Booking History", "color: #F7931E; font-size: 12px;");
</script>
